...
func (r *JetJob) ValidateCreate() error {
	jetjoblog.Info("validate create", "name", r.Name)
...
func (r *JetJob) ValidateUpdate(old runtime.Object) error {
	jetjoblog.Info("validate update", "name", r.Name)

	return nil
}

// ValidateDelete implements webhook.Validator so a webhook will be registered for the type
func (r *JetJob) ValidateDelete() error {
	jetjoblog.Info("validate delete", "name", r.Name)
	return nil
}

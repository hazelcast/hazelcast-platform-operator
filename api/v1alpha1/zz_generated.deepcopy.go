...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExecutorServices) DeepCopyInto(out *ExecutorServices) {
	*out = *in
	if in.BasicExecutorServices != nil {
		in, out := &in.BasicExecutorServices, &out.BasicExecutorServices
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExecutorServices.
func (in *ExecutorServices) DeepCopy() *ExecutorServices {
	if in == nil {
		return nil
	}
	out := new(ExecutorServices)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ScheduledExecutorServiceConfiguration) DeepCopyInto(out *ScheduledExecutorServiceConfiguration) {
	*out = *in
	out.DurableExecutorServiceConfiguration = in.DurableExecutorServiceConfiguration
}

...
func (r *HazelcastEndpoint) ValidateCreate() error {
...
func (r *HazelcastEndpoint) ValidateUpdate(old runtime.Object) error {
...
func (r *HazelcastEndpoint) ValidateDelete() error {

...
//+kubebuilder:webhook:path=/validate-hazelcast-com-v1beta1-cronhotbackup,mutating=false,failurePolicy=ignore,sideEffects=None,groups=hazelcast.com,resources=cronhotbackups,verbs=create;update,versions=v1beta1,name=vcronhotbackup.kb.io,admissionReviewVersions=v1

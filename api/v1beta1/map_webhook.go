...
//+kubebuilder:webhook:path=/validate-hazelcast-com-v1beta1-map,mutating=false,failurePolicy=ignore,sideEffects=None,groups=hazelcast.com,resources=maps,verbs=create;update,versions=v1beta1,name=vmap.kb.io,admissionReviewVersions=v1

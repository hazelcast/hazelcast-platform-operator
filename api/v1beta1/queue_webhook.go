...
//+kubebuilder:webhook:path=/validate-hazelcast-com-v1beta1-queue,mutating=false,failurePolicy=ignore,sideEffects=None,groups=hazelcast.com,resources=queues,verbs=create;update,versions=v1beta1,name=vqueue.kb.io,admissionReviewVersions=v1

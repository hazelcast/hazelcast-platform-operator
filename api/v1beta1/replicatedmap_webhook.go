...
//+kubebuilder:webhook:path=/validate-hazelcast-com-v1beta1-replicatedmap,mutating=false,failurePolicy=fail,sideEffects=None,groups=hazelcast.com,resources=replicatedmaps,verbs=create;update,versions=v1beta1,name=vreplicatedmap.kb.io,admissionReviewVersions=v1

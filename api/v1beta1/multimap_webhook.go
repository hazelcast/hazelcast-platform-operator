...
//+kubebuilder:webhook:path=/validate-hazelcast-com-v1beta1-multimap,mutating=false,failurePolicy=ignore,sideEffects=None,groups=hazelcast.com,resources=multimaps,verbs=create;update,versions=v1beta1,name=vmultimap.kb.io,admissionReviewVersions=v1

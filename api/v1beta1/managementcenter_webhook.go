...
//+kubebuilder:webhook:path=/validate-hazelcast-com-v1beta1-managementcenter,mutating=false,failurePolicy=ignore,sideEffects=None,groups=hazelcast.com,resources=managementcenters,verbs=create;update,versions=v1beta1,name=vmanagementcenter.kb.io,admissionReviewVersions=v1

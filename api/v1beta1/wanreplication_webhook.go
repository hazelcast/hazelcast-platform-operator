...
//+kubebuilder:webhook:path=/validate-hazelcast-com-v1beta1-wanreplication,mutating=false,failurePolicy=ignore,sideEffects=None,groups=hazelcast.com,resources=wanreplications,verbs=create;update,versions=v1beta1,name=vwanreplication.kb.io,admissionReviewVersions=v1

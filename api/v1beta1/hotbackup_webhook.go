...
//+kubebuilder:webhook:path=/validate-hazelcast-com-v1beta1-hotbackup,mutating=false,failurePolicy=ignore,sideEffects=None,groups=hazelcast.com,resources=hotbackups,verbs=create;update,versions=v1beta1,name=vhotbackup.kb.io,admissionReviewVersions=v1

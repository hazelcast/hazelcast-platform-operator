...
var _ = Describe("Hazelcast", Label("hz"), func() {
	...
	Context("Cluster creation", func() {
		It("should create a Hazelcast cluster with a custom name", Label("fast"), func() {
		...
		It("should update ready members status in Hazelcast cluster", Label("fast"), func() {
		...
		It("should update detailed members status in Hazelcast cluster", Label("fast"), func() {
		...
		It("should validate correct pod names and IPs for Hazelcast members", Label("fast"), func() {
	...
	Context("Handling errors", func() {
		...
		It("should reflect external API errors in Hazelcast CR status", Label("fast"), func() {
	...
	Context("Cluster deletion", func() {
		It("should delete dependent data structures and backups on Hazelcast CR deletion", Label("fast"), func() {
			if !ee {
	...
	Context("TLS Configuration", func() {
		It("should form a cluster with TLS configuration enabled", Label("fast"), func() {
			if !ee {
				Skip("This test will only run in EE configuration")
			}
		...
		It("should support mutual TLS authentication in Hazelcast cluster", Label("fast"), func() {
			if !ee {
				Skip("This test will only run in EE configuration")
			}

...
func fillTheMapDataPortForward(ctx context.Context, hz *hazelcastv1beta1.Hazelcast, localPort, mapName string, entryCount int) {
...
func waitForMapSizePortForward(ctx context.Context, hz *hazelcastv1beta1.Hazelcast, localPort, mapName string, mapSize int, timeout Duration) {
...
func memberConfigPortForward(ctx context.Context, hz *hazelcastv1beta1.Hazelcast, localPort string) string {
	cfg := ""
...
func mapConfigPortForward(ctx context.Context, hz *hazelcastv1beta1.Hazelcast, localPort, mapName string) codecTypes.MapConfig {
...
func assertClusterStatePortForward(ctx context.Context, hz *hazelcastv1beta1.Hazelcast, localPort string, state codecTypes.ClusterState) {
...
func clusterStatePortForward(ctx context.Context, hz *hazelcastv1beta1.Hazelcast, localPort string) codecTypes.ClusterState {

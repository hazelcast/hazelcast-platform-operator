...
test-ph: generate fmt vet ## Run end-to-end tests
	USE_EXISTING_CLUSTER=true ACK_GINKGO_DEPRECATIONS=1.16.4 NAME_PREFIX=$(NAME_PREFIX) go test -v ./test/ph -coverprofile cover.out -namespace $(NAMESPACE) -eventually-timeout 8m -timeout 30m -delete-timeout 8m $(GO_TEST_FLAGS)

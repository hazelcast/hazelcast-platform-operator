...
test-ph: generate fmt vet ## Run phone-home tests
	USE_EXISTING_CLUSTER=true NAME_PREFIX=$(NAME_PREFIX) PHONE_HOME_ENABLED=true go test -v ./test/ph -coverprofile cover.out -namespace $(NAMESPACE) -eventually-timeout 8m -timeout 30m -delete-timeout 8m $(GO_TEST_FLAGS)

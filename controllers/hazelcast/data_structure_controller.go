...
func initialSetupDS(ctx context.Context,
	...
	logger logr.Logger) (hzclient.ClientI, ctrl.Result, error) {
...
func getHZClient(ctx context.Context, c client.Client, obj client.Object, ns, hzResourceName string, cs *hzclient.ClientManager) (hzclient.ClientI, ctrl.Result, error) {

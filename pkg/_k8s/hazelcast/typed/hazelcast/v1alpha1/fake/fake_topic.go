...
var topicsResource = schema.GroupVersionResource{Group: "hazelcast", Version: "v1alpha1", Resource: "topics"}

var topicsKind = schema.GroupVersionKind{Group: "hazelcast", Version: "v1alpha1", Kind: "Topic"}
...
func (c *FakeTopics) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(topicsResource, c.ns, name, opts), &v1alpha1.Topic{})

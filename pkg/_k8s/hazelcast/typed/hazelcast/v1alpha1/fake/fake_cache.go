...
var cachesResource = schema.GroupVersionResource{Group: "hazelcast", Version: "v1alpha1", Resource: "caches"}

var cachesKind = schema.GroupVersionKind{Group: "hazelcast", Version: "v1alpha1", Kind: "Cache"}

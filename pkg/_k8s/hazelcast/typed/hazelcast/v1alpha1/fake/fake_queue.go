...
var queuesResource = schema.GroupVersionResource{Group: "hazelcast", Version: "v1alpha1", Resource: "queues"}

var queuesKind = schema.GroupVersionKind{Group: "hazelcast", Version: "v1alpha1", Kind: "Queue"}
